let graphql,path,resolve,fetch;_f34‍.x([["sourceNodes",()=>sourceNodes],["createPages",()=>createPages]]);_f34‍.w("gatsby",[["graphql",["graphql"],function(v){graphql=v}]]);_f34‍.w("path",[["default",["path"],function(v){path=v}],["resolve",["resolve"],function(v){resolve=v}]]);_f34‍.w("isomorphic-fetch",[["default",["fetch"],function(v){fetch=v}]]);
