let graphql,path,resolve,fetch;_ee6‍.x([["sourceNodes",()=>sourceNodes],["createPages",()=>createPages]]);_ee6‍.w("gatsby",[["graphql",["graphql"],function(v){graphql=v}]]);_ee6‍.w("path",[["default",["path"],function(v){path=v}],["resolve",["resolve"],function(v){resolve=v}]]);_ee6‍.w("isomorphic-fetch",[["default",["fetch"],function(v){fetch=v}]]);
